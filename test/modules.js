...
describe("Module APIs get: "+url+"/modules",function(){
	...
	it("should return object must contain result key with object and object must contain request key",function(done){
		request
		.get(url+'/modules')
		.end(function(err, res){
			assert.property(res.body,'error');
	...
	it("should return object must contain result key with object and object must contain request key with array ",function(done){
		request
		.get(url+'/modules')
		.end(function(err, res){
	...
	it("should return object must contain result key with object and object must contain request key with array of object",function(done){
		request
		.get(url+'/modules')
		.end(function(err, res){
			assert.isObject(res.body.result.result[0]);
			done();
		})
	});
